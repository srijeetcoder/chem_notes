export const unit7Notes = [
  {
    ...
    questionsAndAnswers: [
      {
        question: "Explain magnetic behaviour of free radicals and carbonium ions.",
        answer: "The magnetic properties of chemical species depend on the presence of unpaired electrons. \n\n1. **Free Radicals (Paramagnetic):**\n- Free radicals are neutral or charged species that possess **at least one unpaired electron** in their valence shell.\n- Because of this odd, unpaired electron, they have a permanent magnetic moment and are attracted by an external magnetic field. Therefore, they are **paramagnetic** in nature. The degree of paramagnetism corresponds to the number of unpaired electrons.\n\n2. **Carbonium Ions / Carbocations (Diamagnetic):**\n- Carbocations are positively charged species containing a trivalent carbon atom with a sextet of electrons (6 valence electrons).\n- In a typical carbocation (such as the methyl cation $\\text{CH}_3^+$), all six valence electrons around the central carbon are paired up in three bonding orbitals.\n- Since there are no unpaired electrons, the net magnetic moment is zero. Consequently, carbocations are weakly repelled by magnetic fields, classifying them as **diamagnetic**.",
        type: "long",
        marks: "5 Marks"
      }
    ]
