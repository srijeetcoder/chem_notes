export const unit6Notes = [
  {
    ...
    importantPoints: [
      ...
      "In a Newman projection, the dihedral angle is the angle between a bond on the front carbon and a bond on the back carbon, ranging from 0° (eclipsed) to 180° (anti).",
      "Wedge-Dash formulas are the standard representation for showing absolute stereochemistry in IUPAC structures.",
      "Fischer projections must be drawn with the most oxidized carbon (C1) at the top of the vertical chain."
    ],
    commonQuestions: [
  ...
  },
  {
    ...
    explanation: "Isomerism is divided into two main categories: 1. Structural Isomerism: Atoms are connected in a different order. This includes chain isomerism (different carbon frameworks), position isomerism (functional groups on different carbons), and functional isomerism (different functional groups, e.g., ethanol vs. dimethyl ether). 2. Stereoisomerism: Atoms have the same connections but different spatial arrangements. Stereoisomers are further classified into: a. Conformational isomers (conformers): Can interconvert rapidly at room temperature by rotating around single σ-bonds (e.g., chair vs. boat cyclohexane). b. Configurational isomers: Cannot interconvert without breaking and reforming chemical bonds. These are subdivided into enantiomers (non-superimposable mirror images) and diastereomers (non-superimposable non-mirror images, which include cis/trans geometric isomers).",
    formulas: [
      "Maximum number of stereoisomers = 2^n (where n = number of chiral centers, assuming no meso compounds)"
    ],
    equations: [
      "Structural Isomers: C2H6O -> CH3-CH2-OH (Ethanol) and CH3-O-CH3 (Dimethyl Ether)",
      "Geometric Isomers (Diastereomers): cis-but-2-ene and trans-but-2-ene"
    ],
    applications: [
    ...
    importantPoints: [
      ...
      "Enantiomers have identical physical properties in an achiral environment, but rotate plane-polarized light in opposite directions.",
      "Diastereomers have different physical and chemical properties, making them easier to separate than enantiomers.",
      "Meso compounds have chiral centers but are achiral overall due to an internal plane of symmetry, reducing the total number of stereoisomers below 2^n."
    ],
    commonQuestions: [
      "Define isomerism. Classify the different types of isomers with examples.",
      "Distinguish between structural isomers and stereoisomers. Give examples of functional and geometric isomerism.",
      "Calculate the number of stereoisomers possible for 2,3-dichlorobutane. Identify any meso compounds."
    ],
    shortAnswer: "Isomers share the same molecular formula. Structural isomers differ in atom connectivity (e.g., chain, position, functional). Stereoisomers have the same connectivity but different 3D shapes. They include conformers (interconvert by bond rotation) and configurational isomers (enantiomers and diastereomers, which require bond breaking to interconvert).",
    longAnswer: "Isomerism is a central concept in organic chemistry. Isomers are molecules that have the same molecular formula but different chemical structures. They are divided into structural (constitutional) isomers and stereoisomers. Structural isomers differ in the connectivity of their atoms. This category includes chain isomers (differences in the carbon skeleton, like butane and isobutane), position isomers (differing locations of a functional group, like 1-propanol and 2-propanol), and functional isomers (different functional groups, like ethanol (alcohol) and dimethyl ether (ether)). Stereoisomers have the same molecular formula and atom connectivity, but their atoms are arranged differently in space. They are divided into conformational and configurational isomers. Conformational isomers can interconvert by rotation around single carbon-carbon σ-bonds. Because the energy barriers to rotation are low, these conformers (such as the staggered and eclipsed forms of ethane, or the chair and boat forms of cyclohexane) exist in dynamic equilibrium at room temperature. Configurational isomers can only be interconverted by breaking and reforming covalent bonds. This group is further divided into enantiomers and diastereomers. Enantiomers are non-superimposable mirror images of each other, occurring in chiral molecules. Diastereomers are stereoisomers that are not mirror images, such as cis/trans geometric isomers (e.g., maleic acid and fumaric acid) or molecules with multiple chiral centers that differ in configuration at some, but not all, centers."
  },
  {
    unitNumber: 6,
    unitTitle: "Stereochemistry",
    ...
    explanation: "1. D/L System: Used primarily for sugars and amino acids. In a Fischer projection, if the hydroxyl group (-OH) on the bottom-most chiral carbon points to the right, it is a D-sugar; if it points to the left, it is an L-sugar. Similarly, L-amino acids have the amino group (-NH2) on the left. 2. R/S System: The standard absolute configuration system. We assign configurations using three steps: a. Assign priorities (1 to 4) to the four groups attached to the chiral center based on atomic number (higher atomic number = higher priority). If the first atoms are identical, compare the next atoms along the chain. b. Orient the molecule so that the lowest priority group (4) points away from the viewer (represented by a dash). c. Trace a path from priority 1 → 2 → 3. If the path is clockwise, the configuration is R (rectus, right). If the path is counterclockwise, it is S (sinister, left).",
    formulas: [
      "Priority order: I > Br > Cl > F > O > N > C > H (Based on atomic number)",
      "Path 1 → 2 → 3: Clockwise = R, Counterclockwise = S (When group 4 points away)"
    ],
    equations: [
      "Fischer projection rule: If the lowest priority group (4) is on a horizontal bond, the configuration is reversed (apparent clockwise is S, apparent counterclockwise is R)."
    ],
    applications: [
